    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">Sign Up User System</p>
          ...
          <form method="post">
            ...
            <div class = "row">
            <div class="col-5">
            <a class="btn btn-primary" href="pages_client_index.php" >User-Login </a>
            </div>
            <div class="col-5">
            <a class="btn btn-primary" href="admin/pages_index.php" >Admin-Login </a>
            </div>
              </div>
              <br>
            <div class="row">
