          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header"> 
                ...
                <h3 class="card-title">If you want to manage you accounts please click on the green button 

                     or If you want to close you accounts please click on the Red button </h3>
              </div>
              <div class="card-body">
